defmodule ForumWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ForumWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ForumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ForumWeb.Gettext, "errors", msg, opts)
    end
  end
